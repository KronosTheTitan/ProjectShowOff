	...
	public class Stick {
		...
		public Stick(string stickName, Gamepad gamepad, int index, bool isEnabled) {
			...
			if (index == 0 || index == 1) { // Sticks
				horizontalAxis = new Axis (Utils.Utils.os + "_" + name + "_Horizontal");
				verticalAxis = new Axis (Utils.Utils.os + "_" + name + "_Vertical");
			}
			
			if (index == 2) { // DPad
				horizontalAxis = new Axis (Utils.Utils.os + "_" + name + "_Horizontal", 
					Utils.Utils.os + "_" + name + "_Right", 
					Utils.Utils.os + "_" + name + "_Left");
				verticalAxis = new Axis (Utils.Utils.os + "_" + name + "_Vertical", 
					Utils.Utils.os + "_" + name + "_Up", 
					Utils.Utils.os + "_" + name + "_Down");
			}
		}
		...
		protected virtual Vector2 GetPosition() {
			...
			return (Utils.Utils.stickPositionMultiplier/(1 - Settings.stickDeadZone) 
