...
namespace Packages.Hinput.Scripts.Utils
{
	/// <summary>
	...
	public static class Hinput {
		...
		private static List<Gamepad.Gamepad> _gamepad;
		/// <summary>
		/// A list of 8 gamepads, labelled 0 to 7.
		/// </summary>
		public static List<Gamepad.Gamepad> gamepad { 
			get {
				Updater.CheckInstance();
				if (_gamepad == null) {
					_gamepad = new List<Gamepad.Gamepad>();
					for (int i=0; i<Utils.maxGamepads; i++) _gamepad.Add(new Gamepad.Gamepad(i));
				}
		...
		private static Gamepad.Gamepad _anyGamepad;
		/// <summary>
		...
		/// </summary>
		public static Gamepad.Gamepad anyGamepad { 
			get { 
				Updater.CheckInstance();
		...
		/// </summary>
		public static Pressable.Pressable anyInput { get { return anyGamepad.anyInput; } }
	}
}